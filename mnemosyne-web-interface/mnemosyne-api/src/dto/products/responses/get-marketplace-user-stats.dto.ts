import { MarketplaceUserStatsInterface } from '@interfaces/marketplace-user-stats.interface';
import { ApiProperty } from '@nestjs/swagger';
import { DocsProperty } from '@interfaces/docs-property.enum';

export class GetMarketplaceUserStatsDto {
  @ApiProperty({
    type: Number,
