import { ContactTemplateInterface } from '@interfaces/contact-template.interface';
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:30px 30px 18px 30px; line-height:28px; text-align:inherit; background-color:#fff;" height="100%" valign="top" bgcolor="#fff" role="module-content">
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center"><span style="color: #000; font-size: 32px; font-family: inherit">${contactTitle}</span></div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#fff;" height="100%" valign="top" bgcolor="#fff" role="module-content">
                                                                                            <div>
                                                                                                <div>
                                                                                                    <ul>
                                                                                                        <li style="color: #000"><b>${fromTitle}:</b> <p>${from}</p></li>
                                                                                                      <li style="color: #000"><b>${messageTitle}:</b> <p>${message}</p></li>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
