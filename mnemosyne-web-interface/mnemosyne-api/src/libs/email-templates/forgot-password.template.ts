                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:30px 30px 18px 30px; line-height:28px; text-align:inherit; background-color:#fff;" height="100%" valign="top" bgcolor="#fff" role="module-content">
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center"><span style="color: #000; font-size: 32px; font-family: inherit">${welcomeTitle}</span></div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#fff;" height="100%" valign="top" bgcolor="#fff" role="module-content">
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: inherit"><span style="color: #000; font-size: 15px">${forgotPasswordPayload}</span></div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center" bgcolor="#ffc94c" class="inner-td" style="cursor:pointer; border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                                            <a href="${confirmationLink}" style="cursor:pointer;background-color:#ffc94c; border:1px solid #ffc94c; border-color:#ffc94c; border-radius:40px; border-width:1px; color:#3f4259; display:inline-block; font-size:15px; font-weight:normal; letter-spacing:0px; line-height:25px; padding:12px 18px 10px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit; width:168px;" target="">${resetPasswordButton}</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
