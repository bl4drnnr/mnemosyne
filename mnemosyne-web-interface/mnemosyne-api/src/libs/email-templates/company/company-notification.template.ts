import { CompanyNotificationInterface } from '@interfaces/company-notification.interface';
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#fff;" height="100%" valign="top" bgcolor="#fff" role="module-content">
                                                                                            <div>
                                                                                                ...
                                                                                                <div>
                                                                                                    <ul>
                                                                                                        <li style="color: #000"><b>${performedByTitle}:</b> <a href="mailto:${performedBy}">${performedBy}</a></li>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
