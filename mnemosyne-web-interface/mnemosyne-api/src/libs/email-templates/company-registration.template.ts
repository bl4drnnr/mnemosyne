...
export const companyRegistrationTemplate = ({
  ...
  switch (language) {
    case Language.EN:
      ...
      content = 'Thank you for choosing to be the part of our community. It seems like you want to create a company/organization and be able to invite other users, huh? Not a big deal! Click the button below in order to set up company account. You will be requested to set up the password, personal data and recovery keys of owner\'s account. Company data can be changed later on.';
