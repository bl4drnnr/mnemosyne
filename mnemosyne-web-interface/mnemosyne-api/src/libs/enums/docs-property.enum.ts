export enum DocsProperty {
  ...
  COMPANY_ROLE_ID_DESC = 'Company role ID',
  COMPANY_ROLE_ID_EXAMPLE = '4eea51f7-ebf1-4470-b54e-eb3b8c79bf2c',
  ...
  SEARCHED_PRODUCTS_DESC = 'The list of found by the user query products',
  PRODUCT_BY_SLUG = 'Product instance by the slug',
  PRODUCT_PIC_DESC = 'Product picture name',
  PRODUCT_PIC_EXAMPLE = 'asd',
  PRODUCT_SLUG_DESC = 'Product slug for the link',
  PRODUCT_SLUG_EXAMPLE = 'my-product-123',
  PRODUCT_TITLE_DESC = 'Product name',
  PRODUCT_TITLE_EXAMPLE = 'My product',
  PRODUCT_DESC_DESC = 'Product description',
  PRODUCT_DESC_EXAMPLE = 'My product desc',
  ...
  PRODUCT_POSTED_MESSAGE_DESC = 'Response message that the product has been posted',
  PRODUCT_POSTED_MESSAGE_EXAMPLE = 'product-posted',
  PRODUCT_POSTED_LINK_DESC = 'Link where user will be redirected when the product is posted',
  PRODUCT_POSTED_LINK_EXAMPLE = 'https://mnemosyne.io/marketplace/product/my-product-123',
  PRODUCT_CURRENCY_DESC = 'Product currency',
  PRODUCT_CURRENCY_EXAMPLE = 'PLN',
  PRODUCT_LOCATION_DESC = 'The location of the product',
  PRODUCT_LOCATION_EXAMPLE = '5th Avenu',
